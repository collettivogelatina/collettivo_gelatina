...
export default function GelatinoModal({ isOpen, onClose }: GelatinoModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("Nome e Cognome", name);
      formData.append("Email/Contatto", email);
      formData.append("Titolo della Poesia", title);
      formData.append("_subject", "Nuova Poesia Gelatino:  (da )");
      ...
      >
        ...
        {status === "sent" ? (
          <div className="text-center py-10">
            ...
            <p className="text-gray-600">Grazie! L'abbiamo ricevuta e la leggeremo con cura.</p>
            <button 
              onClick={handleClose}
