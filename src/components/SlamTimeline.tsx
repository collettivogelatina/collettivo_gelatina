...
const TIMELINE: TEvent[] = [
  ...
  { id: 15, label: "Prossimamente",  title: "Il Prossimo Slam",       desc: "Il palco è pronto. La data sarà annunciata presto. Tieni d'occhio questo spazio.",                         tag: "IN ARRIVO",     past: false },
];
